...
def send_air_quality_alerts():
    ...
    @task(
        inlets=[Dataset("air_quality_data")],
    )
    def get_air_quality_data_last_20min(**context):
        """
    ...
    @task(
        outlets=[Dataset("air_quality_alert")],
    )
    ...
    _get_air_quality_data_last_20min = get_air_quality_data_last_20min()
    _calculate_aq_averages_last_20min = calculate_aq_averages_last_20min(
        _get_air_quality_data_last_20min
    )
